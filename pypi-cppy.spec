...
Source0  : https://files.pythonhosted.org/packages/1e/84/62a09daa04e732a5763ec22dbc11b988e5140a77b418ea70bba9ab1a77a5/cppy-1.3.0.tar.gz
...
%prep
%setup -q -n cppy-1.3.0
cd %{_builddir}/cppy-1.3.0
pushd ..
cp -a cppy-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732644494
